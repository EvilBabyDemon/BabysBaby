        ...
        switch (subcmd) {
            ...
            default:
                ...
                for (int i = 0; i < Data.covid.length-5; i++) {
                    ...
                    // x2 = x1 / y1 * y2 
                    double temp = Data.covid[Data.covid.length-5] / ((double) Data.covid[i]) * Data.covid[Data.covid.length-(Data.covid.length-5)+i];
                    avg += temp;
                    amount++;
                ...
                double normal = Data.covid[Data.covid.length-5] / ((double) Data.covid[Data.covid.length-6]) * Data.covid[Data.covid.length-1];   
